...
const ApiKeyInput: React.FC<ApiKeyInputProps> = ({ onSave }) => {
  ...
  return (
    <div className="max-w-xl mx-auto bg-white rounded-2xl p-8 shadow-card-hover border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-white border border-gray-300 rounded-xl px-4 py-3 text-dark focus:ring-2 focus:ring-primary focus:border-primary outline-none transition-all duration-200 shadow-sm"
        ...
        <button
          type="submit"
          className="w-full bg-primary hover:bg-primary/90 text-white font-bold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
        >
          Save and Continue
        </button>
      </form>
      <div className="mt-6 text-center space-y-4">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-5">
          <div className="flex items-start space-x-3">
            <svg className="w-6 h-6 text-amber-600 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
